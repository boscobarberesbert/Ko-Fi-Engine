...
//	for (Texture& tex : componentMaterial->texture) {
//		
...
//		Json jsonGameObject;
//
//		std::string idString = std::to_string((int)gameObject->GetUID());
//
...
//		{
//			GameObject* child = (*ch);
//			jsonGameObject["children_id_list"].push_back((int)child->GetUID());
//		}
//
//		if (gameObject->GetParent() != nullptr)
//			jsonGameObject["parent"] = (int)gameObject->GetParent()->GetGetUIDId();
//		else
//			jsonGameObject["parent"];
//
//		jsonGameObject["id"] = (int)gameObject->GetUID();
//
//		jsonFile[sceneName]["game_objects_list"].push_back(jsonGameObject);
//	}
//
//	jsonFile[sceneName]["root_go"] = (int)scene->rootGo->GetUID();
//
