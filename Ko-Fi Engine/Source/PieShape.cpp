...
// CylinderShape.cpp
// ============
// CylinderShape for OpenGL with (base radius, top radius, height, sectors, stacks)
...
// ctor
///////////////////////////////////////////////////////////////////////////////
PieShape::PieShape(float baseRadius, float topRadius, float height, int sectors,
...
// setters
///////////////////////////////////////////////////////////////////////////////
void PieShape::set(float baseRadius, float topRadius, float height, int sectors,
...
// print itself
///////////////////////////////////////////////////////////////////////////////
void PieShape::printSelf() const
{
    std::cout << "===== CylinderShape =====\n"
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::draw(float4x4 transform, float red, float green, float blue, float alpha) const
{
    // interleaved array
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::drawLines(const float lineColor[4]) const
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void PieShape::drawWithLines(const float lineColor[4]) const
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::buildVerticesSmooth()
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::buildVerticesFlat()
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::buildUnitCircleVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void PieShape::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> PieShape::getSideNormals()
{
    const float PI = acos(-1);
    float sectorStep = 2 * PI / sectorCount;
    float sectorAngle;  // radian
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> PieShape::computeFaceNormal(float x1, float y1, float z1,  // v1
