...
public:
    // ctor/dtor
    PieShape(float baseRadius = 1.0f, float topRadius = 1.0f, float height = 1.0f,
    ...
    void draw(float4x4 transform = float4x4::identity, float red = 1.0f, float green = 1.0f, float blue = 1.0f, float alpha = 1.0f) const;          // draw all
