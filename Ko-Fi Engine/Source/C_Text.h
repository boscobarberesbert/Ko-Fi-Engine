...
public:
	...
	inline void SetColorRGBA(const int r, const int g, const int b, const int a) { col.r = (unsigned int)r; col.g = (unsigned int)g; col.b = (unsigned int)g; col.a = (unsigned int)a; }
private:
